...
import net.mcreator.demonic.procedures.BookRightClickedInAirProcedure;
...
public class BookItem extends DemonicModElements.ModElement {
	@ObjectHolder("demonic:book")
	public static final Item block = null;
	public BookItem(DemonicModElements instance) {
		super(instance, 4);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			double z = entity.getPosZ();
			{
				...
				BookRightClickedInAirProcedure.executeProcedure($_dependencies);
			}
			return ar;
		}
