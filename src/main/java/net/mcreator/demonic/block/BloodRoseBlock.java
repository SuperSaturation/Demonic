...
import net.mcreator.demonic.procedures.BloodRoseMobplayerCollidesWithPlantProcedure;
...
public class BloodRoseBlock extends DemonicModElements.ModElement {
	@ObjectHolder("demonic:blood_rose")
	public static final Block block = null;
	public BloodRoseBlock(DemonicModElements instance) {
		super(instance, 30);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				BloodRoseMobplayerCollidesWithPlantProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
