...
import net.mcreator.demonic.procedures.RosePlantRightClickedProcedure;
...
public class RoseBlock extends DemonicModElements.ModElement {
	@ObjectHolder("demonic:rose")
	public static final Block block = null;
	public RoseBlock(DemonicModElements instance) {
		super(instance, 29);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				RosePlantRightClickedProcedure.executeProcedure($_dependencies);
			}
