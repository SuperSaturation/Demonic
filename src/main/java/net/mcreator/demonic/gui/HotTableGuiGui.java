...
package net.mcreator.demonic.gui;
...
import net.mcreator.demonic.procedures.TakenProcedure;
import net.mcreator.demonic.procedures.Taken1Procedure;
import net.mcreator.demonic.procedures.HotTableUpdateTickProcedure;
import net.mcreator.demonic.DemonicModElements;
import net.mcreator.demonic.DemonicMod;
...
public class HotTableGuiGui extends DemonicModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public HotTableGuiGui(DemonicModElements instance) {
		super(instance, 22);
	...
	public void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.openContainer instanceof GuiContainerMod) {
			...
			double z = entity.getPosZ();
			{
				...
				HotTableUpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
	}
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("hot_table_gui"));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				DemonicMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("demonic:textures/hot_table_gui.png");
		@Override
		...
		if (slotID == 0 && changeType == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				TakenProcedure.executeProcedure($_dependencies);
			}
		}
		...
		if (slotID == 2 && changeType == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				Taken1Procedure.executeProcedure($_dependencies);
			}
		}
